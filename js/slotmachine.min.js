  ...
  (d.$el = $(a)),
    ...
    (d.endSpin = function () {
      ...
      var a = -(d.liHeight * d.options.endNum - d.liHeight),
        b = (d.spinSpeed * d.liCount) / (d.options.endNum * 5);
      console.log(d.spinSpeed);
      console.log(d.liCount);
      console.log(d.options.endNum);
      console.log($.noop);
      d.$el
        .css("top", -3000)
        .animate({ top: 0 + "px" }, b, d.options.easing, function () {
          if (
