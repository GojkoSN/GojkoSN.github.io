...
($.fn.playSpin = function (a) {
  ...
  ($.fn.stopSpin = function () {
    $("#listOfUsers ul").stop(true, true);
    console.log($("#listOfUsers ul"));
    if (this.length) {
      if (!$(this).is(":animated")) return;
      $(this)[0].hasAttribute("data-playslot") &&
        $.each(startSeqs["mainSeq" + $(this).attr("data-playslot")], function (
          a,
          b
        ) {
          b.spinning = !1;
  ...
  (d.$el = $(a)),
    ...
    (d.setup = function () {
      ...
      (d.liHeight = a.innerHeight()),
        ...
        (d.spinSpeed = d.options.time / (d.options.loops * 4)),
    ...
    (d.startSpin = function (stop) {
      d.$el
        .css("top", -30000)
        .animate({ top: "0px" }, d.spinSpeed, "linear", function () {
          console.log("inside start spin anime");
          d.lowerSpeed();
        });
    }),
    ...
    (d.endSpin = function () {
      console.log("eneterd end spin");

      d.$el
        .css("top", -3000)
        .animate({ top: 0 + "px" }, 6000, d.options.easing, function () {
          if (
